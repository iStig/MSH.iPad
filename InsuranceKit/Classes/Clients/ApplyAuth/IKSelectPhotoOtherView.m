...
@implementation IKSelectPhotoOtherView
...
//        LocalizeStringFromKey(@"kShootingOther")];
            ...
            titleLab.text =LocalizeStringFromKey(@"kShootingOther");
...
- (void)finishClicked{
     [IKApplyClaimsPhotoInformation sharedApplyClaimsPhotoInformation].photoOtherArr = aryList;
 ...
 */
+ (id)view{
    IKSelectPhotoOtherView *v = [[IKSelectPhotoOtherView alloc] initWithFrame:CGRectMake(0, 0, 1024, 768)];
    return v;
}
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info{
    ...
    if (sub >= 10) {
        ...
        NSString *type = [NSString stringWithFormat:@"%d",IKPhotoTypeClaimClaimsOtherList];
...
-(int)getSub{
    ...
    int photoOtherCount = [aryList count];
