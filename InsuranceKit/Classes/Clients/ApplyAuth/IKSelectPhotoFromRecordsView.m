...
@implementation IKSelectPhotoFromRecordsView
...
//        LocalizeStringFromKey(@"kShootingOther")];
            ...
            titleLab.text =LocalizeStringFromKey(@"kShootingRecords");
...
- (void)finishClicked{
    ...
    [IKApplyClaimsPhotoInformation sharedApplyClaimsPhotoInformation].photoCardArr = aryList;
 ...
 */
+ (id)view{
    IKSelectPhotoFromRecordsView *v = [[IKSelectPhotoFromRecordsView alloc] initWithFrame:CGRectMake(0, 0, 1024, 768)];
    return v;
}
...
//    if ([aryList count] >= 10) {
    ...
    if (sub >= 10) {
        ...
        NSString *type = [NSString stringWithFormat:@"%d",IKPhotoTypeInsuranceCard];
...
-(int)getSub{
    ...
    int photoCarCount = [aryList count];
    int photoOtherCount = [[IKApplyClaimsPhotoInformation sharedApplyClaimsPhotoInformation].photoOtherArr count];
    int photoPaymentCount = [[IKApplyClaimsPhotoInformation sharedApplyClaimsPhotoInformation].photoPaymentArr count];
    int sub =photoCarCount+photoOtherCount+photoPaymentCount;
    return sub;
}
-(int)getOtherPhotoCount{

    int photoOtherCount = [[IKApplyClaimsPhotoInformation sharedApplyClaimsPhotoInformation].photoOtherArr count];
    int photoPaymentCount = [[IKApplyClaimsPhotoInformation sharedApplyClaimsPhotoInformation].photoPaymentArr count];
    int otherPhotoCount =photoOtherCount+photoPaymentCount;
    return otherPhotoCount;
