...
@protocol IKSelectPhotoOtherViewDelegate

- (void)recordsAdded:(NSArray *)photos;

@end

@interface IKSelectPhotoOtherView : UIView<UIActionSheetDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,IKRecordSelectorDelegate>{
    UIImageView *imgvBG;
...
@property (nonatomic,weak) id<IKSelectPhotoOtherViewDelegate> delegate;
