...
@implementation IKAddRecordsPhotoView
 ...
 */
+ (id)view{
    IKAddRecordsPhotoView *v = [[IKAddRecordsPhotoView alloc] initWithFrame:CGRectMake(0, 0, 1024, 768)];
    return v;
}
- (void)show{
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info{
    ...
    if ([aryList count] >= 10) {
//        LocalizeStringFromKey(@"kPhotoLoadCount")
